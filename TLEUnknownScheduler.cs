...
namespace SpaceTrack.Services
{
    public class TLEUnknownScheduler : BackgroundService
    {
        ...
        private readonly ILogger<TLEUnknownScheduler> _logger;


        public TLEUnknownScheduler(IServiceProvider serviceProvider , ILogger<TLEUnknownScheduler> logger)
        {
            ...
            while (!stoppingToken.IsCancellationRequested)
            {
                ...
                try
                {
                    ...
                    await tleService.SaveOrUpdateAllUnknownTLEsAsync(); // Call the method
                                                                        // Fetch latest unknown TLEs from DB
                    ...
                    _logger.LogInformation("Unknown TLE and ECI updates completed successfully.");
                }
                catch (Exception ex)
                {
